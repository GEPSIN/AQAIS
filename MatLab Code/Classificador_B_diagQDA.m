...
%Classificador Bayessiano (Quadratica) = para usar essa função passa-se o vetor de
...
function [Classe, Erro, Post] = Classificador_B_diagQDA (CaracT, vector, Res)
...
%==========================================================================
[Classe, Erro, Post] = classify(teste, treino, grupo, 'diagQuadratic'); % Função usada para classificar
